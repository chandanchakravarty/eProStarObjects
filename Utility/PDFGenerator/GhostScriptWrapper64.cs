...
namespace GhostscriptSharp
{
    ...
    /// </summary>
    public class GhostscriptWrapper64
    {
        ...
        public static void GenerateOutput(string inputPath, string outputPath, GhostscriptSettings64 settings)
        {
            ...
            int height)
        {
            ...
            GhostscriptSettings64 s = new GhostscriptSettings64();
            s.Device = Settings.GhostscriptDevices64.jpeg;
            s.Page.Start = firstPage;
            s.Page.End = lastPage;
            s.Resolution = new System.Drawing.Size(width, height);

            Settings.GhostscriptPageSize64 pageSize = new Settings.GhostscriptPageSize64();
            pageSize.Native = GhostscriptSharp.Settings.GhostscriptPageSizes64.a7;
            s.Size = pageSize;
        ...
        private static string[] GetArgs(string inputPath,
            string outputPath,
            GhostscriptSettings64 settings)
        {
            System.Collections.ArrayList args = new System.Collections.ArrayList(ARGS);

            if (settings.Device == Settings.GhostscriptDevices64.UNDEFINED)
            {
            ...
            if (settings.Size.Native == Settings.GhostscriptPageSizes64.UNDEFINED && settings.Size.Manual.IsEmpty)
            {
            ...
            // Page size
            if (settings.Size.Native == Settings.GhostscriptPageSizes64.UNDEFINED)
            {
    ...
    /// </summary>
    public class GhostscriptSettings64
    {
        private Settings.GhostscriptDevices64 _device;
        private Settings.GhostscriptPages64 _pages = new Settings.GhostscriptPages64();
        private System.Drawing.Size _resolution;
        private Settings.GhostscriptPageSize64 _size = new Settings.GhostscriptPageSize64();

        public Settings.GhostscriptDevices64 Device
        {
            get { return this._device; }
            set { this._device = value; }
        }

        public Settings.GhostscriptPages64 Page
        {
        ...
        public Settings.GhostscriptPageSize64 Size
        {
...
namespace GhostscriptSharp.Settings
{
    ...
    /// </summary>
    public class GhostscriptPages64
    {
    ...
    /// </summary>
    public enum GhostscriptDevices64
    {
        UNDEFINED,
        png16m,
        pnggray,
    ...
    /// </summary>
    public class GhostscriptPageSize64
    {
        private GhostscriptPageSizes64 _fixed;
        ...
        public System.Drawing.Size Manual
        {
            set
            {
                this._fixed = GhostscriptPageSizes64.UNDEFINED;
                this._manual = value;
            }
            get
            {
        ...
        /// Standard paper size
        /// </summary>
        public GhostscriptPageSizes64 Native
        {
            set
            {
                this._fixed = value;
    ...
    /// </remarks>
    public enum GhostscriptPageSizes64
    {
        UNDEFINED,
        ledger,
        legal,
