...
namespace eProStarServices
{
    public class BatchProcessNonEBClaim
    {
        ...
        public BatchProcessNonEBClaim(ConfigurationSettingReader ConfigReader)
        {
        ...
        public void beginProcess()
        {
            ...
            //for (i = 1; i < iCount; i++)
            {
                ...
                mstrConStr = _ConfigReader.ConnString;// System.Configuration.ConfigurationManager.ConnectionStrings[i].ConnectionString;
        ...
        {
            _strInitialFilePath = _ConfigReader.NonEBClaimFolderPath;// ConfigurationSettingReader.NonEBClaimFolderPath.ToString();
