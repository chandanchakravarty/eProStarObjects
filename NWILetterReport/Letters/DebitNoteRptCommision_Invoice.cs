...
using System.Data;
    ...
    /// </summary>
    public partial class DebitNoteRptCommision_Invoice : Telerik.Reporting.Report
    {
        ...
        public DebitNoteRptCommision_Invoice(DataSet dsObj, string strUWCode, string strCheckedInstl)
        {
           
            InitializeComponent();
            picBox1.Value = clsReportUtility.setClientLogo();
