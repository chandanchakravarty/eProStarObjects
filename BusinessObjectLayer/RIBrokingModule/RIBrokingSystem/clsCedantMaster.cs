...
namespace BusinessObjectLayer.RIBrokingModule.RIBrokingSystem
{
    public class clsCedantMaster
    {
        public int RecId { get; set; }
        public int CedantId { get; set; }
        public string CedantCode { get; set; }
        public string CedantName { get; set; }
        public string ChCedantName { get; set; }
    ...
    public class CedantContacts
    {
        public int ContactId { get; set; }
        public int CedantId { get; set; }
        public int CedantForModule { get; set; }
