namespace eProStarReports.AccountReports
{
    ...
    /// <summary>
    /// Summary description for BatchPrintDebitNote.
    /// </summary>
    public partial class BatchPrintDebitNote : Telerik.Reporting.Report
    {
        ...
        public BatchPrintDebitNote(string Param1, string Param2)
        {
            InitializeComponent();
            ...
            if (DsreportDetails.Tables[0].Rows.Count > 0)
            {
                ...
                if (_client.ToUpper() == "STARACCLAIM")
                {
                    ...
                    textBox35.Value = DsreportDetails.Tables[0].Rows[0]["DrCrDescription"].ToString();
                    textBox34.Value = ConvertIntoNumeric(Convert.ToDecimal(DsreportDetails.Tables[0].Rows[0]["Amount"].ToString()));
                    textBox30.Value = ConvertIntoNumeric(Convert.ToDecimal(DsreportDetails.Tables[0].Rows[0]["LocalAmount"].ToString()));
                    textBox44.Value = ConvertIntoNumeric(Convert.ToDecimal(DsreportDetails.Tables[0].Rows[0]["GST"].ToString()));
                ...
                else
                {
                    ...
                    textBox32.Value = ConvertIntoNumeric(Convert.ToDecimal(DsreportDetails.Tables[0].Rows[0]["LocalAmount"].ToString()));
                }
