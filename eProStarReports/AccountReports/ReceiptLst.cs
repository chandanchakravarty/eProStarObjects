namespace eProStarReports.AccountReports
{
    ...
    /// </summary>
   internal partial class ReceiptLst : Telerik.Reporting.Report
    {
        public ReceiptLst()
        {
            //
        ...
        public ReceiptLst(DataSet ds,string Rpttype)
        {
           ...
           // textBox7.Value = "L.C.H.(S) PTE LTD";
            textBox7.Value = ds.Tables[0].Rows[0]["CompanyName"].ToString();
            ...
            txtRepId.Value = ((Rpttype == "R") ? "receipt" : "payment") + "_listing_" + DateTime.Now.ToString("HH:mm");
