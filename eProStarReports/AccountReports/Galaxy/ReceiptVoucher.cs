namespace eProStarReports.AccountReports.Galaxy
{
    ...
    internal partial class ReceiptVoucher : Telerik.Reporting.Report
    {
        ...
        public ReceiptVoucher(DataSet DsComp, DataSet DsClient, DataSet DsVoucher, DataSet DsBank)
        {
            ...
            txtAddress42.Value = DsComp.Tables[0].Rows[0]["Add1"].ToString();
            // +" " + DsComp.Tables[0].Rows[0]["Add2"].ToString() + " " + DsComp.Tables[0].Rows[0]["Add3"].ToString();
            //txtAddress43.Value = DS.Tables[0].Rows[0]["Add2"].ToString();
            textBox31.Value = DsComp.Tables[0].Rows[0]["Add2"].ToString();
            textBox41.Value = DsComp.Tables[0].Rows[0]["Add3"].ToString();
            ...
            {
                textBox34.Value = DsBank.Tables[0].Rows[0]["BankName"].ToString();
                textBox1.Value = DsBank.Tables[0].Rows[0]["ChequeNo"].ToString();
            }
            else
            {
