namespace eProStarReports.IHReports
{
    ...
    /// <summary>
    /// Summary description for RptIHSafetySummaryCanSBT.
    /// </summary>
   internal partial class RptIHSafetySummaryCanSBT : Telerik.Reporting.Report
    {
        public RptIHSafetySummaryCanSBT(DataSet dsObj)
        {
            InitializeComponent();
