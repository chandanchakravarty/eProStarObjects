...
using Telerik.Reporting.Drawing;
    ...
    public partial class PrintRenewalSummary : Telerik.Reporting.Report
    {
        ...
        public PrintRenewalSummary(DataRow dr,DataTable dt,string pg)
        {
            ...
            //textBox36.Value = dr["TotalAmtPayable"].ToString();
            textBox36.Value = (Convert.ToDecimal((string.IsNullOrEmpty(textBox32.Value.Trim()) ? "0" : textBox32.Value)) + Convert.ToDecimal((string.IsNullOrEmpty(textBox34.Value) ? "0" : textBox34.Value))).ToString();
            textBox32.Value = String.Format("{0:#,###0.00}", Convert.ToDecimal((string.IsNullOrEmpty(textBox32.Value.Trim()) ? "0" : textBox32.Value)));
