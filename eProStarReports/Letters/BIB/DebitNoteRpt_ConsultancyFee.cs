namespace eProStarReports.Letters.BIB
{
    ...
    internal partial class DebitNoteRpt_ConsultancyFee : Telerik.Reporting.Report
    {
        ...
        public DebitNoteRpt_ConsultancyFee(DataSet dsObj, string CaseRefNo, string DebitNoteNo, string Type, DataTable _taxType = null)
        {

            InitializeComponent();
            //added for Redmine #34590
            if (_taxType.Rows.Count>0 && _taxType.Rows[0]["TaxType"] != null && _taxType.Rows[0]["TaxType"].ToString() == "SST")//_taxType.ToUpper() == "SST")
            {
