   ...
   internal partial class DebitNoteRptGeneral_LCH : Telerik.Reporting.Report
    {
        ...
        public DebitNoteRptGeneral_LCH(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, string printlogo)
        {
            ...
            if (dsObj.Tables.Count > 0)
            {
                ...
                txtTextNote.Value = "This is not a Tax Invoice. The Insurance company's tax invoice is attached or will be sent to you shortly.Please issue cheque payable to " + txtTextLCH.Value;
            }
        }
