namespace eProStarReports.Letters
{
    ...
    /// </summary>
   internal partial class DNCNNoteMotorExcess_LCH : Telerik.Reporting.Report
    {
        ...
        public DNCNNoteMotorExcess_LCH(DataSet dsObj, int showHide, string printlogo)
        {
            //
            // Called for Clients
            //
            InitializeComponent();
            if (printlogo == "Y" || printlogo == "N")
            {
                SetDataOnReport(dsObj);
                MotorPremCalc(dsObj);
                MotorDetails(dsObj.Tables[3].Rows[0], showHide);
            ...
            {
                SetDataOnReportUw(dsObj, printlogo);
                MotorPremCredit(dsObj, printlogo);
                MotorDetails(dsObj.Tables[3].Rows[0], showHide);
            }
        ...
        public DNCNNoteMotorExcess_LCH(DataSet dsObj, DataRow drMotorPremDetails, string strIndividualSum, int showHide, string printlogo)
        {
            //
            // Called for Clients
            //
        ...
        public DNCNNoteMotorExcess_LCH(DataSet dsObj, int showHide, string UwCode, string printlogo)
        {
            //
            // Called for Underwriters
            //
        ...
        public DNCNNoteMotorExcess_LCH(DataSet dsObj, DataRow drMotorPremDetails, int showHide, string UwCode, string printlogo)
        {
            //
            // Called for Underwriters
            //
        ...
        private void MotorPremCalc(DataSet dsObj, DataRow drPremDetails, string strIndividualSum)
        {
            ...
            if (drPremDetails["InsurerGSTPer"] != DBNull.Value) tempPremGstPer = Convert.ToDecimal(drPremDetails["InsurerGSTPer"].ToString());      // added for #23642
            if (drPremDetails["M_UWBrokerage"] != DBNull.Value) tempBrokeragePer = Convert.ToDecimal(drPremDetails["M_UWBrokerage"].ToString());      // added for #23642
            if (drPremDetails["M_BrokerGST"] != DBNull.Value) tempBrkGstPer = Convert.ToDecimal(drPremDetails["M_BrokerGST"].ToString());      // added for #23642
        ...
        private void MotorPremCalc(DataSet dsObj)
        {
            ...
            if (dsObj.Tables[3].Rows[0]["InsurerGSTPer"] != DBNull.Value) tempPremGstPer = Convert.ToDecimal(dsObj.Tables[3].Rows[0]["InsurerGSTPer"].ToString());      // added for #23642
            if (dsObj.Tables[3].Rows[0]["M_UWBrokerage"] != DBNull.Value) tempBrokeragePer = Convert.ToDecimal(dsObj.Tables[3].Rows[0]["M_UWBrokerage"].ToString());
            if (dsObj.Tables[3].Rows[0]["M_BrokerGST"] != DBNull.Value) tempBrkGstPer = Convert.ToDecimal(dsObj.Tables[3].Rows[0]["M_BrokerGST"].ToString());
            tempPremGstAmt = (tempBasicLessNcd * tempPremGstPer) / 100;
            tempBrkAmnt = (tempBasicLessNcd * tempBrokeragePer) / 100;
            tempBrkGstAmt = (tempBasicLessNcd * tempBrkGstPer) / 100;
        ...
        private void MotorPremCredit(DataSet dsObj, string UwCode)
        {
            ...
            for (int i = 0; i < dtViewTable.Rows.Count; i++)
            {
                ...
                if (dtViewTable.Rows[0]["InsurerGSTPer"] != DBNull.Value) tempPremGstPer = Convert.ToDecimal(dtViewTable.Rows[0]["InsurerGSTPer"].ToString());      // added for #23642
                tempTotPremGstPer += tempPremGstPer;
                if (dtViewTable.Rows[0]["M_UWBrokerage"] != DBNull.Value) tempBrokeragePer = Convert.ToDecimal(dtViewTable.Rows[0]["M_UWBrokerage"].ToString());      // added for #23642
                tempTotBrokeragePer += tempBrokeragePer;
                if (dtViewTable.Rows[0]["M_BrokerGST"] != DBNull.Value) tempBrkGstPer = Convert.ToDecimal(dtViewTable.Rows[0]["M_BrokerGST"].ToString());      // added for #23642
