namespace eProStarReports.Letters.LCH
{
    ...
    /// </summary>
   internal partial class DebitNoteRptGeneral_LCH : Telerik.Reporting.Report
    {
        ...
        public DebitNoteRptGeneral_LCH(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, string printlogo)
        {
            //
            // Required for telerik Reporting designer support
            //
            ...
            if (dsObj.Tables.Count > 3 && dsObj.Tables[3].Columns.Contains("ClientShare"))
            {
                ...
                decimal sumInstlmt = 0;//Convert.ToDecimal(sumObject);
        ...
        public DebitNoteRptGeneral_LCH(DataSet dsObj, string strUWCode, string strCheckedInstl, string printlogo)
        {
            //
            // Required for telerik Reporting designer support
            //
        ...
        public DebitNoteRptGeneral_LCH(DataSet dsObj, string strClientCode, int clientFlag, string printlogo)
        {
            //
            // Required for telerik Reporting designer support
            //
        ...
        public DebitNoteRptGeneral_LCH(DataSet dsObj, string strUWCode, string printlogo)
        {
            //
            // Required for telerik Reporting designer support
            //
