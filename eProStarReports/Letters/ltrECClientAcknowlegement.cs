namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrECClientAcknowlegement.
    /// </summary>
   internal partial class ltrECClientAcknowlegement : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;    
        public ltrECClientAcknowlegement()
        {
            //
        ...
        public ltrECClientAcknowlegement(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
