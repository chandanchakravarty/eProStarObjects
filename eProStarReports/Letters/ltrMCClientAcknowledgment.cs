namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrMCClientAcknowledgment.
    /// </summary>
   internal partial class ltrMCClientAcknowledgment : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrMCClientAcknowledgment()
        {
            //
        ...
        public ltrMCClientAcknowledgment(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
