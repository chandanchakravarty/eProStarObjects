namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrMVUWFaxAcknowledgement.
    /// </summary>
   internal partial class ltrMVUWFaxAcknowledgement : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrMVUWFaxAcknowledgement()
        {
            //
        ...
        public ltrMVUWFaxAcknowledgement(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
