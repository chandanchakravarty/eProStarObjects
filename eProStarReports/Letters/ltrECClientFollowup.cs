namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrECClientFollowup.
    /// </summary>
   internal partial class ltrECClientFollowup : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrECClientFollowup()
        {
            //
        ...
        public ltrECClientFollowup(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
