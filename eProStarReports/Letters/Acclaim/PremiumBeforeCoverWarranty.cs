namespace eProStarReports.Letters.Acclaim
{
    ...
    /// <summary>
    /// Summary description for PremiumBeforeCoverWarranty.
    /// </summary>
    public partial class PremiumBeforeCoverWarranty : Telerik.Reporting.Report
    {
        public PremiumBeforeCoverWarranty()
        {
            //
        ...
        public PremiumBeforeCoverWarranty(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, String Username)
        {
        ...
        public PremiumBeforeCoverWarranty(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, String Username, string installment)
        {
