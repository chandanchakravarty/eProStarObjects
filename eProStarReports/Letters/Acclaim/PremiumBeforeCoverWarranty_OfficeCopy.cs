namespace eProStarReports.Letters.Acclaim
{
    ...
    /// <summary>
    /// Summary description for PremiumBeforeCoverWarranty_OfficeCopy.
    /// </summary>
    public partial class PremiumBeforeCoverWarranty_OfficeCopy : Telerik.Reporting.Report
    {
        public PremiumBeforeCoverWarranty_OfficeCopy()
        {
            //
        ...
        public PremiumBeforeCoverWarranty_OfficeCopy(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, String Username)
        {
        ...
        public PremiumBeforeCoverWarranty_OfficeCopy(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, String Username,string installment)
        {
