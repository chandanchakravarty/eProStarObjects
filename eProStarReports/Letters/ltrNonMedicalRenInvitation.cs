namespace eProStarReports.Letters
{
    ...
    /// </summary>
   internal partial class ltrNonMedicalRenInvitation : Telerik.Reporting.Report
    {
        public ltrNonMedicalRenInvitation()
        {
            //
        ...
        public ltrNonMedicalRenInvitation(List<clsEBRenewalLetter> objLetter, DataSet dsFooterCountry)
        {
            //
            // Required for telerik Reporting designer support
            //
