namespace eProStarReports.Letters
{
    ...
    /// </summary>
    internal partial class PremiumReportSG : Telerik.Reporting.Report
    {
        public PremiumReportSG()
        {
            //
        ...
        public PremiumReportSG(DataSet dsObj, string lstrtype, string DebitNoteNo, string PolicyFrom, string PolicyTo, string ClientCode, string ClientSource, string status, string CustomizedClient, string TransType)
        {
            InitializeComponent();
