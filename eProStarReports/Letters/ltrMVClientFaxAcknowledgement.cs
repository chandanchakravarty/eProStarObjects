namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrMVClientFaxAcknowledgement.
    /// </summary>
   internal partial class ltrMVClientFaxAcknowledgement : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrMVClientFaxAcknowledgement()
        {
            //
        ...
        public ltrMVClientFaxAcknowledgement(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
