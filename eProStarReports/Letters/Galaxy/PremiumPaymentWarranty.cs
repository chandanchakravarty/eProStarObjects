namespace eProStarReports.Letters.Galaxy
{
    ...
    /// <summary>
    /// Summary description for PremiumPaymentWarranty.
    /// </summary>
    public partial class PremiumPaymentWarranty : Telerik.Reporting.Report
    {
        public PremiumPaymentWarranty()
        {
            //
        ...
        public PremiumPaymentWarranty(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, string Username, string paymentWarrantyType, string printlogo, string strDebitNoteNo, string Blank)
        {
            InitializeComponent();

            string packagePolicy = dsObj.Tables[16].Rows[0]["PackagePolicy"].ToString();

            txtTopCompanyName.Value = dsObj.Tables[1].Rows[0]["TopCompanyName"].ToString();
            txtTopCompanyAddress.Value = dsObj.Tables[1].Rows[0]["CompanyAdd1"].ToString()+" " + dsObj.Tables[1].Rows[0]["CompanyAdd2"].ToString();
            txtCompanyAdd2.Value =dsObj.Tables[1].Rows[0]["CompanyAdd3"].ToString();
            txtTopCompanyEmail.Value = dsObj.Tables[1].Rows[0]["TopCompanyEmail"].ToString();
            ...
            //{
            //    dv1.RowFilter = "ClientCode = '" + strClientCode + "' and DebitNoteNo1='" + strDebitNoteNo + "'";
            //}
            //else
            //    dv1.RowFilter = "ClientCode = '" + strClientCode + "' and DebitNoteNo='" + strDebitNoteNo + "'";
            dv1.RowFilter = "ClientCode = '" + strClientCode + "' and DebitNoteNo='" + strDebitNoteNo + "'"; // Added for Redmine #33455(Crash)
            ...
            if ((dtViewTable1 != null && dtViewTable1.Rows.Count > 0) && (dtViewTable != null && dtViewTable.Rows.Count > 0))
            {
                ...
                if (paymentWarrantyType == "PPW")
                    typeReportSource2.TypeName = "eProStarReports.Letters.Acclaim.INPPWDetails, eProStarReports, Version=" + "1.0.0.0, Culture=neutral, PublicKeyToken=null";
                else if (paymentWarrantyType == "PBCW")
                    typeReportSource2.TypeName = "eProStarReports.Letters.Acclaim.INPBCWDetails, eProStarReports, Version=" + "1.0.0.0, Culture=neutral, PublicKeyToken=null";
                else if (paymentWarrantyType == "PIPW")
                    typeReportSource2.TypeName = "eProStarReports.Letters.Acclaim.INPIPWDetails, eProStarReports, Version=" + "1.0.0.0, Culture=neutral, PublicKeyToken=null";
                else if (paymentWarrantyType == "30DGP")
                    typeReportSource2.TypeName = "eProStarReports.Letters.Acclaim.IN30DGPDetails, eProStarReports, Version=" + "1.0.0.0, Culture=neutral, PublicKeyToken=null";

                //subReport1.ReportSource = typeReportSource2;
        ...
        public PremiumPaymentWarranty(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, string Username, string installment, string paymentWarrantyType, string printlogo)
        {
            InitializeComponent();
            txtTopCompanyName.Value = dsObj.Tables[1].Rows[0]["TopCompanyName"].ToString();
            txtTopCompanyAddress.Value = dsObj.Tables[1].Rows[0]["CompanyAdd1"].ToString() + " " + dsObj.Tables[1].Rows[0]["CompanyAdd2"].ToString();
