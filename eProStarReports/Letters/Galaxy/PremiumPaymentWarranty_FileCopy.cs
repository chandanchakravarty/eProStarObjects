namespace eProStarReports.Letters.Galaxy
{
    ...
    /// <summary>
    /// Summary description for PremiumPaymentWarranty_FileCopy.
    /// </summary>
    public partial class PremiumPaymentWarranty_FileCopy : Telerik.Reporting.Report
    {
        public PremiumPaymentWarranty_FileCopy()
        {
            //
        ...
        public PremiumPaymentWarranty_FileCopy(DataSet dsObj, string strClientCode, string strCheckedInstl, int clientFlag, string Username, string Blank1, string printlogo, string strDebitNoteNo, string Blank)
        {
            InitializeComponent();
