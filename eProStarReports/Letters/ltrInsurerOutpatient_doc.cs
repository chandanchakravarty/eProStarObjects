namespace eProStarReports.Letters
{
    ...
    /// </summary>
   internal partial class ltrInsurerOutpatient_doc : Telerik.Reporting.Report
    {
        ...
        public ltrInsurerOutpatient_doc()
        {
            //
        ...
        int num = 0;
        public ltrInsurerOutpatient_doc(List<clsEBLetter> objLettera, DataSet dsFooterCountry, List<EBInsurerInpatientClaims> objClaims, DataSet dsLetterInfo, string DateFormat)
        {
