namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrPARClientAcknowledgement.
    /// </summary>
   internal partial class ltrPARClientAcknowledgement : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrPARClientAcknowledgement()
        {
            //
        ...
        public ltrPARClientAcknowledgement(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
