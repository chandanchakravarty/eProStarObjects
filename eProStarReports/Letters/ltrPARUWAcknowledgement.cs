namespace eProStarReports.Letters
{
    ...
    /// <summary>
    /// Summary description for ltrPARUWAcknowledgement.
    /// </summary>
   internal partial class ltrPARUWAcknowledgement : Telerik.Reporting.Report
    {
        List<clsECLetter> objLetter = null;
        int num = 0;
        public ltrPARUWAcknowledgement()
        {
            //
        ...
        public ltrPARUWAcknowledgement(List<clsECLetter> objLettera, DataSet dsFooterCountry)
        {
