   ...
   public class BatchProcessRawClaim
    {
       ...
       public void BeginProcess()
       {
           try
           {
               ...
               ds = objEBMemberManager.GetBatchRawClaimUpload(objclsEBMemberUpload);
                      ...
                      // strFilepath = path + strFilepath;
                       ...
                       if (File.Exists(strFilepath))
                       {
                           ...
                           if (Path.GetExtension(strFilepath).ToUpper() == ".XLS")
                           {
                               ...
                               // Excel 97-2003 
                               strExcelConn = ConfigurationManager.ConnectionStrings["ExcelConnXLS"].ConnectionString +strFilepath;
                           ...
                           else
                           {
                               ...
                               // Excel 2007
                               strExcelConn = ConfigurationManager.ConnectionStrings["ExcelConnXLSX"].ConnectionString +strFilepath;
