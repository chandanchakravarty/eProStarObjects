...
namespace BusinessAccessLayer.FlexServices.FlexIRM
{
    public class FlexDebitNoteCsvToBS
    {
        ...
        private void loadSourceFile()
        {
            ...
            dsFiles = objExportMan.getAttachmentListByStatus("INV", "PEND");
            string searchPattern = "psirm*.*";
        ...
        public void getFilePath()
        {
            ...
            objExportMan = new ExportManager();
            dsPath = objExportMan.getPathDetail("IRMFlexUpload");
        ...
        public DataTable isExisted(string DebitNoteNo)
        {
            DataSet dsResult = new DataSet();
            objExportMan = new ExportManager();
            dsResult = objExportMan.checkDebitNoteDetail(DebitNoteNo);
        ...
        public DataRow addHeader(DataTable dtTable)
        {
            ...
            drHeader[3] = "D/N No";
            drHeader[4] = "Suffix";
            drHeader[5] = "Is New DN No.";
            drHeader[6] = "Currency Code";
            drHeader[7] = "Cedant Code";
            drHeader[8] = "Billed Amount";
            drHeader[9] = "Settled Amount";
            drHeader[10] = "Outstanding Amount";
            drHeader[11] = "Settlement Date";
            drHeader[12] = "Receipt No.";
            drHeader[13] = "Split No.";
            drHeader[14] = "RI Code";
            drHeader[15] = "Billed Amount (RI)";
            drHeader[16] = "Settled Amount (RI)";
            drHeader[17] = "Outstanding Amount (RI)";
            drHeader[18] = "Settlement Date (RI)";
            drHeader[19] = "Receipt No. (RI)";
            drHeader[20] = "Settlement Seq";
            drHeader[21] = "ParseMsg";
            drHeader[22] = "ParseResult";
            //drHeader[23] = "BatchReferenceID";
            return drHeader; ;
        }
